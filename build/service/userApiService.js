    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.prev = 3;
          _context2.next = 6;
          return _index["default"].User.count(user.username);
        case 6:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return (0, _loginRegisterService.checkUsernameExist)(data.username);
        case 3:
        ...
        case 6:
          ...
          _context4.next = 9;
          return _index["default"].User.create(_objectSpread(_objectSpread({
            userId: (0, _uuid.v4)()
          }, data), {}, {
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 10:
          ...
          return user.update({
            phone: data.phone,
            groupId: data.groupId,
            password: (0, _loginRegisterService.hashUserPassword)(data.password),
            point: data.point,
            pointLock: data.pointLock,
            linkInfo: data.linkInfo,
            status: data.status
...
var updateUserPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          _context6.next = 9;
          return user.update({
            password: (0, _loginRegisterService.hashUserPassword)(data.newPass)
          });
        case 9:
          return _context6.abrupt("return", {
  ...
  return function updateUserPassword(_x5) {
